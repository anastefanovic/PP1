...
public class ConstAssignMultiple extends ConstAssignList {

    private ConstAssignList ConstAssignList;
    private ConstAssign ConstAssign;

    public ConstAssignMultiple (ConstAssignList ConstAssignList, ConstAssign ConstAssign) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstAssignMultiple(\n");
